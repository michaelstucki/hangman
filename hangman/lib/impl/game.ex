defmodule Hangman.Impl.Game do
  ...
  defp reveal_guessed_letters(game) do
    game.letters
    |> Enum.map(fn letter -> MapSet.member?(game.used, letter) |> maybe_revealed(letter) end)
  end

  defp maybe_revealed(true, letter), do: letter
  defp maybe_revealed(false, _letter), do: "_"
